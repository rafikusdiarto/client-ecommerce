    ...
    <div>
        ...
        <section className="text-gray-600 body-font overflow-hidden mt-20">
                <div className="container px-5 py-24 mx-auto">
                        ...
                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-center rounded" src={`http://192.168.230.81:8000/${product && product.product_img}`}/>
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <p className="leading-relaxed">{product && product.product_long_des}</p>
